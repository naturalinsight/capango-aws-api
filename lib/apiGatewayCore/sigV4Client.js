...
sigV4ClientFactory.newClient = function (config) {
    ...
    awsSigV4Client.makeRequest = function (request) {
        ...
        //HACK! Origin is not required in an AWS signature, but it is used in the lambdas.
        //      So we add in AFTER the signature creation.
        //      Might want to put this in a config file.
        if(headers['Origin'] === undefined) {
            headers['Origin'] = "https://employer.capango.com";
		}
